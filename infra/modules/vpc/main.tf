...
# Stateless subnet controls complement the stateful security groups. Public
# subnets receive web traffic for the ALB; private subnets only receive VPC
# application/database traffic plus return traffic for outbound connections.

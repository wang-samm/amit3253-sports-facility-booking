...
<meta name="description" content="<?= htmlspecialchars($pageDescription ?? 'Reserve TAR UMT sports facilities with live court and time-slot availability.') ?>">
...
<body>
<nav class="navbar">
<a class="brand" href="index.php"><img src="assets/tarumt-logo.png" alt="TAR UMT" class="brand-logo">Sports Facility Booking</a>
<div class="nav-links">
